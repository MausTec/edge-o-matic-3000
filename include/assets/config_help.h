...
#define WIFI_ON_HELP _HELPSTR("Enable WiFi and the Websocket server. Cannot be enabled if Bluetooth is on.")
#define BT_DISPLAY_NAME_HELP _HELPSTR("Bluetooth device name, you might wanna change this.")
#define BT_ON_HELP _HELPSTR("Enable Bluetooth connectivity. Cannot be enabled if WiFi is on.")
#define FORCE_BT_COEX_HELP _HELPSTR("Force Bluetooth and WiFi at the same time**.")
